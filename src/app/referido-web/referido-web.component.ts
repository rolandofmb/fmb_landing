...
export class ReferidoWebComponent implements OnInit {
  ...
  @ViewChild('ref_name') ref_name;
  @ViewChild('ref_patern') ref_patern;
  @ViewChild('ref_matern') ref_matern;
  @ViewChild('mailRegis') mailRegis: ElementRef;
  @ViewChild('ref_phone') ref_phone;
  @ViewChild('tipo_referetente') tipo_referetente;
  @ViewChild('ref_cuenta') ref_cuenta;
  ...
  ref_namee = new FormControl('');
  ref_paterne = new FormControl('');
  ref_materne = new FormControl('');
  ref_phonee = new FormControl('');
  tipo_referetentee = new FormControl('');
  ref_cuentaa = new FormControl('');
  mailRegiss = new FormControl('', [Validators.required, this.validMail2.bind(this)]);
  ...
  save() {
    ...
    this.gralService.referidoWeb(this.user).then((data) => {
